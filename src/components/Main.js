    ...
    <>
     <div className="bg-[#0d111a] text-white lg:flex-row lg:h-[500px] h-[1100px] flex lg:space-x-64 flex-col items-center justify-center space-y-10">
        <div className="flex flex-col justify-center items-center space-y-5 ">
          <h1 className=" text-[30px] font-bold lg:text-[30px]">Tackle, Talent Scouting</h1>
          <div className='text-[16px] mx-5 lg:text-[14px] lg:max-w-[500px]'>
            <div>We aim to discover and support talented soccer players lacking
             opportunities due to socio-economic barriers.
             </div>
          </div>
          <div className=" space-y-5 lg:max-w-[500px] mx-8 flex flex-col text-[10px]">
      ...
      <div className="bg-[#131b2a] text-white lg:flex-row h-[1100px] flex-col flex lg:space-x-40   lg:h-[500px] space-y-10 items-center justify-center ">
        <div className=" flex flex-col lg:text-justify space-y-4 items-center">
          ...
          <div className="lg:text-[14px] flex justify-center items-center  flex-col lg:flex-col  mx-[40px]  space-y-2  text-[17px]">
          ...
          <div className="lg:text-[14px] lg:max-w-[445px]  mx-[40px] text-[17px]">
      ...
      <div className="bg-[#0d111a] text-white flex-col h-[400px] flex text-center space-y-2 items-center justify-center">
        ...
        <div className="text-[17px] lg:text-[14px] leading-6 lg:leading-4">The TACKLE official collection 10000 animated 3D NFT is coming soon. By holding an NFT, you will get <br></br>
        exclusive access to future collections, real-world events and meetups. VIP Season Tickets for an unforgettable VIP <br></br>
